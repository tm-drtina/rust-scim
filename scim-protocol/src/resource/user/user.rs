...
use super::{
    Address, Email, Entitlement, GroupMembership, InstantMessaging, Name, PhoneNumber, Photo, Role,
    X509Certificate,
};
...
pub struct User {
    ...
    pub profile_url: Option<String>, // TODO: change to URI
    ...
    /// When a password is set or changed by the client, the cleartext password SHOULD be processed by the service provider as follows:
    ///   *  Prepare the cleartext value for international language comparison.
    ...
    ///   *  Prepares the filter value for international language comparison.
    ///      See Section 7.8 of [RFC7644].
    ///
